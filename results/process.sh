...
grep '#\|true   "read' 1-forceSafe.dat | grep '#\|LmdbJavaByteBuffer' > 1-forceSafe-reads.dat
rm 1-forceSafe.dat
sed -i 's/LmdbJavaByteBuffer" true/safe"/g' 1-forceSafe-reads.dat
sed -i 's/LmdbJavaByteBuffer" false/unsafe"/g' 1-forceSafe-reads.dat
gplot.pl -type png -title "LmdbJavaByteBuffer Unsafe" -xlabel "" -ylabel "Ms / 1M R" -set "nokey; set xtics nomirror rotate by -270" -pointsize 1 -style points -using '3:xtic(2)' -outfile 1-forceSafe-reads.png 1-forceSafe-reads.dat
...
gplot.pl -type png -title "LMDB Sync" -xlabel "" -ylabel "Ms / 1M W" -set "nokey; set xtics nomirror rotate by -270" -pointsize 1 -style points -using '5:xtic(3)' -outfile 1-sync-writes.png 1-sync-writes.dat
...
gplot.pl -type png -title "LMDB Write Map" -xlabel "" -ylabel "Ms / 1M W" -set "nokey; set xtics nomirror rotate by -270" -pointsize 1 -style points -using '5:xtic(3)' -outfile 1-writeMap-writes.png 1-writeMap-writes.dat
...
gplot.pl -type png -title "LMDB Metasync" -xlabel "" -ylabel "Ms / 1M W" -set "nokey; set xtics nomirror rotate by -270" -pointsize 1 -style points -using '5:xtic(3)' -outfile 1-metaSync-writes.png 1-metaSync-writes.dat
...
gplot.pl -type png -title "Native Library Disk Use 1M Non-Seq X Approx 2,000 Byte Values" -xlabel "" -ylabel "Bytes" -set "nokey; set xtics nomirror rotate by -270" -pointsize 1 -style points -using '2:xtic(1)' -outfile 2-size.png 2-size.dat
...
rm 4-seq.dat
plot_4 4-intKey-seq "Integer" "Seq" "100"
plot_4 4-strKey-seq "String" "Seq" "100"
plot_4 4-intKey-rnd "Integer" "Rnd" "100"
plot_4 4-strKey-rnd "String" "Rnd" "100"
...
rm 4-size.dat
gplot.pl -type png -title "Library Disk Use 1M Non-Seq X 100 Byte Values" -xlabel "" -ylabel "Bytes (Non-Compacted)" -set "nokey; set xtics nomirror rotate by -270" -pointsize 1 -style points -using '2:xtic(1)' -outfile 4-size-biggest.png 4-size-biggest.dat
...
rm 5-seq.dat
plot_5 5-intKey-seq "Integer" "Seq" "2048"
plot_5 5-intKey-rnd "Integer" "Rnd" "2048"
